It works independently because it abandons the legacy fbcp compilation process and instead relies purely on the native tools and kernel modules already present in a modern Raspberry Pi OS:
